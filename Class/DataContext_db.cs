    ...
    class DataContext_db
    {
        ...
        public static ObservableCollection<Request> GetRequests()
        {
            ...
            return new ObservableCollection<Request>
            {
                ...
                new Request { IdRequest = 2, RequestText = "Доставить груз_1 в Иваново", RequestStatus = "На выполнении", TransferStart = "Москва", TransferEnd = "Иваново", RequestNextStep = "Выполнено", StgRequestCancel = false, StgRequestEdit = true },
